...
function register_icon_widget( $widgets_manager ) {
    require_once( __DIR__ . '/widgets/icon-widget.php' );
...
function register_shopping_cart_widget( $widgets_manager ) {
    require_once( __DIR__ . '/widgets/shopping-cart-widget.php' );
...
function register_search_button_widget( $widgets_manager ) {
    require_once( __DIR__ . '/widgets/class-elementor-search-button-widget.php' );
...
function register_account_widget( $widgets_manager ) {
    require_once( __DIR__ . '/widgets/class-elementor-account-widget.php' );
